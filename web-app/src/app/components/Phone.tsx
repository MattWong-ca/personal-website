          ...
          partnership with Operation Hope.`}
            ...
            <PopUp title='Projects' open={projectsOpen} onClose={() => setProjectsOpen(false)}>
              <div className={`mt-5 ${garamond400.className}`}>
                ...
                <div style={{ marginLeft: '1.3rem', fontSize: '22px' }}>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Omikave - data marketplace for Omi AI data, powered by Akave <a href="https://github.com/MattWong-ca/omikave" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-5px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                  ...
                  <p className="mb-2.5">➔&nbsp;&nbsp; BANGER! - bet on casts to go viral with Chiliz Fan Tokens <a href="https://github.com/MattWong-ca/banger-bets" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-5px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Castlingo - Chrome extension for language learning on Warpcast <a href="https://github.com/MattWong-ca/castlingo" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-5px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                  ...
                  <p className="mb-2.5">➔&nbsp;&nbsp; FrameGPT - free no-code builder for Farcaster frames <a href="https://ethglobal.com/showcase/framegpt-0gxad" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-5px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Personal website redesign <a href="https://github.com/MattWong-ca/personal-website" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-2px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                </div>
                <p className={`${poppins600.className}`} style={{ lineHeight: 'normal', fontSize: '25px', marginTop: '0.5rem' }}>2023</p>
                <div style={{ marginLeft: '1.3rem', fontSize: '22px' }}>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Swift Tickets - NFT minting gated by Worldcoin&apos;s World ID <a href="https://github.com/MattWong-ca/swift-tickets-navh" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-5px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Various side projects <a href="https://medium.com/@mattwong.ca/all-my-projects-14bf922d0a65" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}><svg className="inline-block" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-5px' }}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 3h6v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 14L21 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></a></p>
                </div>
              </div>
            </PopUp>
