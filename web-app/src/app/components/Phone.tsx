            ...
            <PopUp title='Projects' open={projectsOpen} onClose={() => setProjectsOpen(false)}>
              <div className={`mt-5 ${garamond400.className}`}>
                ...
                <div style={{ marginLeft: '1.3rem', fontSize: '22px' }}>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Neurosaurs - focus game powered by NFTs + Neurosity Crown (<a href="https://github.com/MattWong-ca/neurosaurs" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>link</a>)</p>
