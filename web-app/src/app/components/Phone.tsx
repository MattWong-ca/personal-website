          ...
          <div className="flex items-center justify-center pt-px" style={{ gap: '18px', backgroundColor: 'rgba(240, 240, 240, 0.15)', borderRadius: '26px', width: '290px', height: '75px' }}>
            ...
            <PopUp title='About' open={aboutOpen} onClose={() => setAboutOpen(false)}>
              ...
              <div className={`${garamond400.className} text-black`} style={{ marginLeft: '1.3rem', fontSize: '22px' }}>
                ...
                <p className="mt-1">➔&nbsp;&nbsp; Engineering @ Nethermind, King&apos;s College London</p>
            ...
            <PopUp title='Projects' open={projectsOpen} onClose={() => setProjectsOpen(false)}>
              <div className={`mt-5 ${garamond400.className}`}>
                ...
                <div style={{ marginLeft: '1.3rem', fontSize: '22px' }}>
                  ...
                  <p className="mb-2.5">➔&nbsp;&nbsp; FindMyPhotos.app - find your photos in untagged photo albums <a href="https://github.com/MattWong-ca/find-my-photos" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a> <span>{' '}</span>
                    <a
                      href="https://www.linkedin.com/posts/sutd_sutd-sutdlife-uwaterloo-ugcPost-7323605607712722945-J7IM"
                      target="_blank"
                      style={{ textDecoration: 'underline', color: 'blue' }}
                    >
                      <LinkIcon />
                    ...
                    <a
                      href="https://uwaterloo.ca/biomedical-engineering/news/facial-recognition-app-nets-bme-student-hackathon-win"
                      target="_blank"
                      style={{ textDecoration: 'underline', color: 'blue' }}
                    >
                      <LinkIcon />
                    </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; ETHGlobal Explorer - project showcase with filters <a href="https://x.com/mattwong_ca/status/1875358547569197460" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                </div>
                <p className={`${poppins600.className}`} style={{ lineHeight: 'normal', fontSize: '25px', marginTop: '0.5rem' }}>2024</p>
                <div style={{ marginLeft: '1.3rem', fontSize: '22px' }}>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Omikave - data marketplace for Omi AI data, powered by Akave <a href="https://github.com/MattWong-ca/omikave" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Neurosaurs - concentration game powered by Neurosity <a href="https://github.com/MattWong-ca/neurosaurs" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Endless Scroll - crypto-themed trivia game on Warpcast <a href="https://github.com/MattWong-ca/endless-scroll" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Lingocaster - learn languages by translating casts on Warpcast <a href="https://github.com/Lingo-Labs/lingocaster" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; BANGER! - bet on casts to go viral with Chiliz Fan Tokens <a href="https://github.com/MattWong-ca/banger-bets" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Castlingo - Chrome extension for language learning on Warpcast <a href="https://github.com/MattWong-ca/castlingo" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; EMG Controlled Whisk</p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Translate Bot - language translation for Farcaster <a href="https://github.com/MattWong-ca/translate-bot" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; FrameGPT - free no-code builder for Farcaster frames <a href="https://ethglobal.com/showcase/framegpt-0gxad" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                  <p className="mb-2.5">➔&nbsp;&nbsp; Personal website redesign <a href="https://github.com/MattWong-ca/personal-website" target="_blank" style={{ textDecoration: 'underline', color: 'blue' }}>
                    <LinkIcon />
                  </a></p>
                </div>
